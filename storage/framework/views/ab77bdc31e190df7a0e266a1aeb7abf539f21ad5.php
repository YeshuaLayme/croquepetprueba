<?php if(Admin::user()->visible(\Illuminate\Support\Arr::get($item, 'roles', [])) && Admin::user()->can(\Illuminate\Support\Arr::get($item, 'permission'))): ?>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH E:\Tareas de Tecsup\Tecsup ciclo 6\Emprendimiento\App PROYECTO\ProjectEmpV4 - copia\vendor\encore\laravel-admin\src/../resources/views/partials/menu.blade.php ENDPATH**/ ?>